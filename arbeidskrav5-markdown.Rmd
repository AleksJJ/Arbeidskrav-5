...
Styrketrening med formål å øke maksimal styrke (1RM), eller øke muskeltverrsnittet (CSA) har blitt forsket mye på. Her brukes ofte variabler som motstand, volum, hastighet etc. Det har vist seg at treningsmotstanden er avgjørende for hvilke av disse egenskapene som blir forbedret. En høyere motstand er å foretrekke for å øke 1RM og CSA, mens CSA alene kan økes med lavere motstand og flere repetisjoner @schoenfeld2015.

Styrketreningsprogrammer er ofte lagt opp til at man starter med lav motstand og mange repetisjoner, og utover i programmet så øker progresjonen. Det vil si at man gradvis går mot en høyere motstand med færre repetisjoner. Da legger man opp til å øke CSA og 1RM i løpet av treningsperioden. Progresjon i treningsprogrammet går under grunnleggende treningsprinsipper, men hvor mange sett som er nødvending for å få en respons i CSA eller 1RM avhenger ofte av treningsstatus og gener.

Treningsmotstanden en variabel som kan øke CSA og 1RM, men hvor høyt volum som er nødvendig for å få en respons av disse har forskning vist til forskjellige resultater @krieger2010; @carpinelli1999. Dette forsøket går ut på å teste effekten av 1 sett vs 3 sett på muskelvekst og maksimal styrke. Nullhypotesen er at det ikke er noen forskjell mellom 1 og 3 sett.

#### Metode

##### Utvalg

41 deltakere bestående av kvinner og menn i alderen 18-40 år. 7 av disse fullførte ikke. Eksklusjonskriterier; røyking, eller trent mer enn 1 økt i uken de siste 12 månedene.
...
Deskriptiv statistikk blir presentert som prosentvis endring i gjennomsnitt og standardavvik (m ± SD) med mindre annet er oppgitt. P verdier er regnet ut med ANCOVA analyse mellom pre til post, med kjønn, og sett som co-variat. Signifikansnivå er satt til p \< 0.05. All data er behandlet i R, versjon 1.4.1717, 2009-2021 RStudio, PBC.

#### Resultater

Etter 12 uker trening økte muskelmassen til single sett 2.04 ± 3.7%, og multiple økte med 3.3 ± 4.38% (p\<0.001). I muskelstyrke økte single sett 24.5 ± 12.9%, multiple økte med 31 ± 14.2% (p\<0.001).
...
```{r, echo=FALSE, message=FALSE, warning=FALSE, include=TRUE, results='hide', fig.cap="Figur 1 viser endringen i lean bodymass fra pre til post på alle forsøkspersonene, både single og multiple sett"}
...
```{r, echo=FALSE, message=FALSE, warning=FALSE, include=TRUE, results='hide', fig.cap="Figur 2 viser styrkeendringen fra pre til post på alle forsøkspersonene, både single og multiple sett"}
# Styrkeresultater som skal vises
...
Det viste seg at 3 sett ga signifikant økning i både muskelmasse og maksimal styrke. Etter å ta testet med forskjellige linneære modeller så var det ANCOVA som passet best til å analysere forskjellen mellom gruppene og ga signifikante P verdier. Scatterplottene viste også tegn til homoskedastisitet, og residualene var innenfor coocks distance og lå på linjen på QQ-plottet.

Hass et al gjorde en lignende stude. Der fant de ikke signifikant forskjell mellom gruppene, men
konkluderte med at 1 sett ga god respons uavhengig av treningsstatus @hass2000. \
Kelly et al fant signifikant forskjell hos multiple gruppen i peak torque hos
quadriceps, og konkluderte med at 3 sett vil kunne gi bedre styrkeøkning enn 1
sett @Kelly2007.
